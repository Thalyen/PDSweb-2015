...
class AnunciosControllerTest < ActionController::TestCase
  ...
  test "should create anuncio" do
    assert_difference('Anuncio.count') do
      post :create, anuncio: { anexo: @anuncio.anexo, descricao: @anuncio.descricao, tipo: @anuncio.tipo, titulo: @anuncio.titulo }
    end
  ...
  test "should update anuncio" do
    patch :update, id: @anuncio, anuncio: { anexo: @anuncio.anexo, descricao: @anuncio.descricao, tipo: @anuncio.tipo, titulo: @anuncio.titulo }
    assert_redirected_to anuncio_path(assigns(:anuncio))
  end
